...
and air quality studies \citep[e.g.][]{Mcmillan:2010kx, Wang:2011uq}.
	...
	Normalized frequency distributions (\unit{\%/ppmv}) of TES and WRF-Chem ozone mixing ratios between (a)
	150--300~\unit{hPa} and (b) 300--450~\unit{hPa}. Only columns between 25--40$^\circ$N are used.}
...
In conclusion, WRF-Chem overestimates the ozone concentration throughout the troposphere. However, spatial and temporal variability caused by large-scale
dynamics are observed at individual locations affected by the ozone enhancement. The high bias within the mid-to-upper troposphere is largely constrained
but increases substantially above 200\,\unit{hPa}.
