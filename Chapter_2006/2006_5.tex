...
By comparing the changes in the distribution of chemical tendencies of \chem{O_3} and \chem{O_x}, it is apparent that
...
ozone loss caused by \chem{NO_x}-titration compensated ozone production by the air mass of which $L_N/Q<2/3$.
	...
	\begin{wrapfigure}{o}{0.5\textwidth}
		...
		\caption[\chem{CO}-\chem{O_3} model correlation]{{\label{fig:2006/ltngsens_o3conv}
